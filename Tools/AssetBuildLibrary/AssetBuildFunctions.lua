...
NewAssetTypeInfo( "shaders",
	{
		ConvertSourceRelativePathToBuiltRelativePath = function( i_sourceRelativePath )
			...
			return relativeDirectory .. fileName .. ".bshader"
		end,
...
NewAssetTypeInfo( "effects",
	{
		ConvertSourceRelativePathToBuiltRelativePath = function( i_sourceRelativePath )
			...
			-- but you could change this to customize the way that you build assets
			-- (you could, for example, use a different extension for binary shaders)
			return relativeDirectory .. fileName .. ".beffect"
		end,
		GetBuilderRelativePath = function()
		...
		RegisterReferencedAssets = function( i_sourceRelativePath )
			...
			if DoesFileExist( sourceAbsolutePath ) then
				...
				RegisterAssetToBeBuilt( effect["vertex_shader"], "shaders", { "vertex" } )
				RegisterAssetToBeBuilt( effect["fragment_shader"], "shaders", { "fragment" } )
			end
		end
	}
)
...
NewAssetTypeInfo( "meshes",
	{
		ConvertSourceRelativePathToBuiltRelativePath = function( i_sourceRelativePath )
			...
			-- but you could change this to customize the way that you build assets
			-- (you could, for example, use a different extension for binary shaders)
			return relativeDirectory .. fileName .. ".bmesh"
		end,
		GetBuilderRelativePath = function()
...
NewAssetTypeInfo( "collider",
	{
		ConvertSourceRelativePathToBuiltRelativePath = function( i_sourceRelativePath )
			...
			-- but you could change this to customize the way that you build assets
			-- (you could, for example, use a different extension for binary shaders)
			return relativeDirectory .. fileName .. ".bcollider"
		end,
		GetBuilderRelativePath = function()
			return "ColliderBuilder.exe"
		end,
	}
)
