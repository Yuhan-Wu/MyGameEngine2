...
//			fout << std::fixed;
				...
				"{" "\n";
			{
				fout << "\t" "vertices = {" "\n";
				{
					for each (sVertexInfo vertex in i_vertexArray)
					{
						sVertex_maya cur_vertex = vertex.vertex;
						fout << "\t\t" "{" "\n";
						// position
						fout << "\t\t\t" "position = " "{";
						fout << cur_vertex.x << ", " << cur_vertex.y << ", " << cur_vertex.z;
						fout << "}," "\n";
						// normal
						fout << "\t\t\t" "normal = " "{";
						fout << cur_vertex.nx << ", " << cur_vertex.ny << ", " << cur_vertex.nz;
						fout << "}," "\n";
						// tangent
						fout << "\t\t\t" "tangent = " "{";
						fout << cur_vertex.tx << ", " << cur_vertex.ty << ", " << cur_vertex.tz;
						fout << "}," "\n";
						// bitangent
						fout << "\t\t\t" "bitangent = " "{";
						fout << cur_vertex.btx << ", " << cur_vertex.bty << ", " << cur_vertex.btz;
						fout << "}," "\n";
						// texcoord
						fout << "\t\t\t" "texcoord = " "{";
						fout << cur_vertex.u << ", " << 1 << ", " << cur_vertex.v;
						fout << "}," "\n";
						// color
						fout << "\t\t\t" "color = " "{";
						fout << cur_vertex.r << ", " << cur_vertex.g << ", " << cur_vertex.b << ", " << cur_vertex.a;
						fout << "}," "\n";
						fout << "\t\t" "}," "\n";
					}
				}
				...
				{
					fout << "\t\t";
					// exchange the first and the third
